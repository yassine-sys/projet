...
//     }, []);
  ...
  const crecheFound= props.partenaires.filter(el=>el.categorie=='creche').find(
        (creche) => creche._id==props.match.params.id
        );
            ...
            <div className="d-table-cell">
              <div className="container">
                <div className="page-banner-content">
                  <h2>{crecheFound.partenaire_name}</h2>
                  <ul>
                    <li>
                      <Link strict to='home-page'><a>Home</a></Link>
                    </li>
                    <li>{`Détails du ${crecheFound.categorie}`} </li>
                  </ul>
                </div>
              </div>
            </div>
                ...
                <div className="event-details-information">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      {crecheFound.code_postal}
                    </li>
                    <li>
                      <span>Siteweb: </span>
                      <a>{`www.${crecheFound.partenaire_name}.com`}</a>
                    </li>
                  </ul>
                </div>
              </div>
