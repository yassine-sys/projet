...
const JardinDetail = (props) => {
  ...
  const jardinFound= props.partenaires.filter(el=>el.categorie=='jardin').find(
        (jardin) => jardin._id==props.match.params.id
        );
            ...
            <div className="d-table-cell">
              <div className="container">
                <div className="page-banner-content">
                  <h2>{jardinFound.partenaire_name}</h2>
                  <ul>
                    <li>
                      <Link strict to='home-page'><a>Home</a></Link>
                    </li>
                    <li>{`Détails du ${jardinFound.categorie}`} </li>
                  </ul>
                </div>
              </div>
            </div>
                ...
                <div className="event-details-information">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      {jardinFound.code_postal}
                    </li>
                    <li>
                      <span>Siteweb: </span>
                      <a>{`www.${jardinFound.partenaire_name}.com`}</a>
                    </li>
                  </ul>
                </div>
              </div>
