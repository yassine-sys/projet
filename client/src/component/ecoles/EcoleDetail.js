...
const EcoleDetail = (props) => {
  ...
  const ecoleFound= props.partenaires.filter(el=>el.categorie=='ecole').find(
        (ecole) => ecole._id==props.match.params.id
        );
            ...
            <div className="d-table-cell">
              <div className="container">
                <div className="page-banner-content">
                  <h2>{ecoleFound.partenaire_name}</h2>
                  <ul>
                    <li>
                      <Link strict to='home-page'><a>Home</a></Link>
                    </li>
                    <li>{`Détails du ${ecoleFound.categorie}`} </li>
                  </ul>
                </div>
              </div>
            </div>
                ...
                <div className="event-details-information">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      {ecoleFound.code_postal}
                    </li>
                    <li>
                      <span>Siteweb: </span>
                      <a>{`www.${ecoleFound.partenaire_name}.com`}</a>
                    </li>
                  </ul>
                </div>
              </div>
